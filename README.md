...
## 段付き棒のパラメータ最適化
* イントロダクションと最適設計問題の定式化 ([スライド](./01slide.pdf), [講義メモ](./01memo.pdf))
* Lagrange の未定乗数と KKT 条件 ([スライド](./02slide.pdf), [講義メモ](./02memo.pdf))
* 感度解析 ([スライド](./03slide.pdf), [講義メモ](./03memo.pdf))
  * 直接微分法
  * 随伴変数法
* 最適設計問題の数値解法
  * 制約無しの場合 ([スライド](./04slide.pdf), [講義メモ](./04memo.pdf))
  * 制約付きの場合 ([スライド](./05slide.pdf), [講義メモ](./05memo.pdf))
	* 有効制約法
	* ペナルティ法
	
## 弾性論と有限要素法の基礎
* 2次元静弾性力学
* 有限要素法の基礎とFreeFem++の使い方
